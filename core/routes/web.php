...
Route::get('/donor-login','DonorLoginController@showdonorLoginForm');
Route::post('/donor-login-action','DonorLoginController@donorLogin')->name('donor.login');
Route::get('/donor-logout','DonorLoginController@donorLogout')->name('donor.logout');
